...
<div class="mt-5justify-content-center align-items-center position-relative" id="carrusel">
    ...
    <h2 class="txt-logo position-absolute">TRANSYLVANIA<br>METAL PUB</h2>
    ...
    <div id="carouselIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="img/carr1.jpg" alt="">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/carr2.jpg" alt="">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/carr3.jpg" alt="">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/carr4.jpg" alt="">
            </div>
        </div>
        <!--Control anterior-->
