        ...
        <nav class="navbar navbar-expand-sm fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-danger" href="#section-gallery">GALERÍA</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-danger" href="#section-about">ACERCA DE</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-danger" href="#section-services">EVENTOS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-danger" href="#section-merchandising">MERCHANDISING</a>
                    </li>
                    <li class="nav-item">
