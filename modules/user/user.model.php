...
// Clase para gestionar los usuarios en la tabla "users"
class User
{
    protected $dbconn;
    ...
    public function login($userName, $userPassword)
    {
        ...
        // Prepare
        $stm = $this->dbconn->prepare("SELECT * FROM users WHERE 
    ...
    public function register($userName, $userPassword)
    {
        ...
        // Prepare
        $stm = $this->dbconn->prepare("INSERT INTO users (user_name, user_password)
